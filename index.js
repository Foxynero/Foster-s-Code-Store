...
app.get('/endpoint', (req, res) => {
  ...
  // GitHub URLs
  const githubFileUrl = 'https://github.com/yourusername/yourrepository/blob/main/yourfile.js'; // Replace with your actual file URL
  const githubSourceCodeUrl = 'https://github.com/yourusername/yourrepository'; // Replace with your actual repository URL
